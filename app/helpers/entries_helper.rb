module EntriesHelper
  def print_item_grants_form(item_fields)
    ...
    Category.find_grants_by_year(year).each_with_index do |category, index|
      ...
      result += "  <input class='form-control amount-input-grants' type='text' value='#{item_grant_amount}' name='#{entry_name_key_prefix}[amount]' id='#{entry_id_key_prefix}_amount'>"
