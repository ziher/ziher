...
sudo -H -u vagrant -i bash -c "/home/vagrant/.rbenv/bin/rbenv install 3.0.7"
sudo -H -u vagrant -i bash -c "/home/vagrant/.rbenv/bin/rbenv global 3.0.7"
...
echo '====================== $ rails server -u webrick -b 0.0.0.0 <enter>'
echo '======================'
